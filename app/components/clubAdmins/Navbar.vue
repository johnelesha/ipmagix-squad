    ...
    <nav class="navbar border-b-[0.3px] border-[#C5C5C5] p-0 py-5" :dir="direction">
        <div class="flex flex-col sm:flex-row justify-end w-full md:px-11 px-6 gap-3">
            ...
            <div class="flex items-center justify-center sm:justify-end gap-3">
                <div class="dropdown dropdown-end content-center mx-2">
                    <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
                        <div class="indicator">
                            ...
                            <span
                                class="badge badge-sm indicator-item bg-[#EF4444] px-2.5 py-3 text-[13px] rounded-full text-white ltr:left-0 top-[-6px] rtl:right-0">1</span>
                        </div>
                    </div>
                ...
                <div class="dropdown dropdown-start sm:dropdown-center lg:dropdown-start content-center mx-5 sm:mx-3">
                    ...
                    <ul
                        tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3
                            w-52 p-0 shadow clubAdminLinks">
                        <li class="px-2">
                            <p
